...
public class DatabaseService : IDatabaseService
{
    ...
    public void UpdateConnectionString(AppConfig cfg)
    {
        _connectionString = BuildConnectionString(cfg);
    }

    private static string BuildConnectionString(AppConfig cfg)
    {
    ...
    public async Task<NpgsqlConnection> GetConnectionAsync()
    {
        ...
        {
            Console.WriteLine($"[DatabaseService] Failed to connect to database: {ex.Message}");
            throw;
        }
    }
    ...
    public async Task InitializeDatabaseAsync()
    {
        ...
        checkCmd.CommandText = "SELECT COUNT(*) FROM app_user";
    ...
    public async Task SeedSampleDataAsync()
    {
        using var conn = await GetConnectionAsync();
        using var checkCmd = conn.CreateCommand();
        checkCmd.CommandText = "SELECT COUNT(*) FROM category";
        var catCount = (long)(await checkCmd.ExecuteScalarAsync())!;
